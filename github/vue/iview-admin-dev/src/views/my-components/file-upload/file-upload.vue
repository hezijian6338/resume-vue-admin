    ...
    <div>
        <Row>
            ...
            <Card>
                ...
                <div class="height-120px">
                    <Row type="flex" justify="center" align="middle" class="height-100">
                        <Upload name="file" ref="image" :data="this.userInfo" action="http://192.168.8.178/rest/upload/" :format="['jpg', 'png', 'jpeg', 'gif', 'bmp', 'svg']" :on-format-error="handleFormatError" :on-success="handleSuccess2" :before-upload="handleBeforeUpload"
                            :on-preview="preview">
                            <span>选择图片上传&nbsp;&nbsp;</span>
                            <Button type="ghost" icon="ios-cloud-upload-outline">上传文件</Button>
                        </Upload>
    ...
    export default {
        ...
        methods: {
            ...
            preview(file) {
                ...
                this.photoPath = "http://192.168.8.178/pdfModel/studentPhoto/" + file.name;
            }
        },
        mounted() {
